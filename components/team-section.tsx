...
const teamMembers = [
  {
    name: "Dr. Sarah Chen",
    role: "Co-Founder & CEO",
    title: "Former Stanford ML Professor",
    image: "/professional-ai-researcher.png",
    bio: "PhD in Computer Science from MIT, former Associate Professor of Machine Learning at Stanford. Published 40+ papers in top-tier AI conferences and led research in neural networks and deep learning applications.",
    ...
    achievements: [
      ...
      "Author of 'Practical AI for Business'",
    ],
    linkedin: "https://linkedin.com/in/sarahchen-ai",
    email: "sarah@base2ml.com",
  },
  {
